#include "data.h" //includes all data members for use in these methods.
...
//fill the sentenceBank structure's columns with random words.
//the last word in each column will be '.'
...
//set the QWERTY territories for the left and right hands' fingers.
...
//set the DSK territories for the left and right hands' fingers.
