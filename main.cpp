...
const int sentenceLength = 251;//change how many words in each sentence. Last one will always be '.'; for example, setting to 2 will
...
void main()
{
	...
	rightHand.fingers[0].territory[6] = 'h';
